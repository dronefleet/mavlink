...
public final class UavionixDialect implements MavlinkDialect<UavionixVehicle> {
    ...
    @Override
    public final UavionixVehicle newVehicle(int systemId, EventSource<Object> incoming,
            EventEmitter<Object> outgoing) {
        return new UavionixVehicle.Impl(systemId, incoming, outgoing);
    }
