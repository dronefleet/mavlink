...
public final class Gps2Rtk {
  ...
  private Gps2Rtk(long timeLastBaselineMs, long tow, int baselineAMm, int baselineBMm,
  ...
  public static class Builder {
    ...
    public final Gps2Rtk build() {
      return new Gps2Rtk(timeLastBaselineMs, tow, baselineAMm, baselineBMm, baselineCMm, accuracy, iarNumHypotheses, wn, rtkReceiverId, rtkHealth, rtkRate, nsats, baselineCoordsType);
    }
  }
}
