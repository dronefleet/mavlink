...
public final class SysStatus {
   ...
   * Value of 1: present. Indices defined by ENUM MAV_SYS_STATUS_SENSOR 
   */
  @MavlinkMessageField(
      position = 1,
      length = 4
   ...
   * Value of 1: enabled. Indices defined by ENUM MAV_SYS_STATUS_SENSOR 
   */
  @MavlinkMessageField(
      position = 2,
      length = 4
   ...
   * of 0: not enabled. Value of 1: enabled. Indices defined by ENUM MAV_SYS_STATUS_SENSOR 
   */
  @MavlinkMessageField(
      position = 3,
      length = 4
